      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData({
                    ...formData,
                    budget_min: parseFloat(cleanValue) || 0,
                  });
                }}
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData({
                    ...formData,
                    budget_max: parseFloat(cleanValue) || 0,
                  });
                }}
                className="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f5d82e] focus:border-transparent"
                placeholder="2000"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, requirements: e.target.value || null })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f5d82e] focus:border-transparent"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                max_ambassadors: parseInt(e.target.value) || 1,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f5d82e] focus:border-transparent"
          />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl transform transition-all">
            ...
            <p className="text-gray-600 text-center mb-6">
              Your campaign &quot;
              <span className="font-semibold">{createdCampaign.title}</span>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-gray-900">
                  ${createdCampaign.budget_min.toFixed(2)} - $
                  {createdCampaign.budget_max.toFixed(2)}
                </span>
              </div>

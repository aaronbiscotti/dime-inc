...
export function ContextPanel({ selectedChatId, userRole }: ContextPanelProps) {
  ...
  // NOTE: Hooks must run unconditionally and before any early returns.
  // Move realtime subscriptions above early returns to preserve hook order across renders.
    ...
    return (
      <>
        ...
        <div className="mb-4 w-full">
          ...
          {userRole === "client" && !contract && (!campaignAmbassador || campaignAmbassador.status !== "proposal_received") && (
            <Button
              variant="default"

...
export const API_ENDPOINTS = {
  ...
  CAMPAIGNS_BY_CLIENT: (clientId: string) => `/api/campaigns/client/${clientId}`,
  ...
  PORTFOLIOS_BY_AMBASSADOR: (ambassadorId: string) => `/api/portfolios/ambassador/${ambassadorId}`,
  PORTFOLIOS_BY_ID: (id: string) => `/api/portfolios/${id}`,
  
  // Contracts
  CONTRACTS_CREATE: '/api/contracts/create',
  CONTRACTS_BY_CLIENT: (clientId: string) => `/api/contracts/client/${clientId}`,
  CONTRACTS_BY_AMBASSADOR: (ambassadorId: string) => `/api/contracts/ambassador/${ambassadorId}`,
